...
const agentInfo: Record<string, {
  ...
  scout: {
    ...
    status: 'demo',
    bgImage: '/background/scout-agent.webp',
  ...
  ticker: {
    ...
    status: 'demo',
    bgImage: '/background/ticker-agent.webp',
  ...
  matcher: {
    ...
    status: 'demo',
    bgImage: '/background/matcher-agent.webp',
    glassVar: 'rgba(255,255,255,0.35)',
    isDark: false,
  },
  quill: {
    ...
    status: 'demo',
    bgImage: '/background/quill-agent.webp',
    glassVar: 'rgba(255,255,255,0.35)',
    isDark: false,
  },
  sage: {
    ...
    status: 'live',
    bgImage: '/background/sage-agent.webp',
